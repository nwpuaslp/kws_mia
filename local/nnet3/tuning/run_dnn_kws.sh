...
if [ $stage -le 7 ]; then
  ...
  relu-batchnorm-layer name=tdnn1 dim=$hid_dim
  relu-batchnorm-layer name=tdnn2 dim=$hid_dim input=Append(-1,0,2)
  relu-batchnorm-layer name=tdnn3 dim=$hid_dim input=Append(-3,0,3)
  relu-batchnorm-layer name=tdnn4 dim=$hid_dim input=Append(-7,0,2)
  relu-batchnorm-layer name=tdnn5 dim=$hid_dim input=Append(-3,0,3)
  relu-batchnorm-layer name=tdnn6 dim=$hid_dim
  output-layer name=output input=tdnn6 dim=$num_tgt max-change=1.5
EOF
